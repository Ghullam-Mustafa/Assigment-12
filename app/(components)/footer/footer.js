    ...
    <div className="pricing bg-[#c6dff8]">
                <div className="w-11/12 mx-auto py-14">
                    <div className=" w-11/12  mx-auto grid md:grid-cols-4 lg:grid-cols-4 sm:grid-cols-2 gap-10 my-10 justify-items-center">
                        <div className="">
                            <Image src="/logo.png" width={100} height={500} />
                            ...
                            <div className="flex">
                                <Image src='/facebook.png' width={27} height={27} />
                                <Image src='/linkedin.png' width={27} height={27} />
                                <Image src='/twitter.png' width={27} height={27} />
                            </div>
                        </div>
